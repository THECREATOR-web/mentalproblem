...
const PROBLEMS = [
  {id:1,name:"Generalized Anxiety",desc:"A pattern of persistent worry and tension that can affect many areas of life. People with generalized anxiety often find themselves anticipating problems, feeling on edge, and having difficulty relaxing. Physical symptoms such as muscle tension, sleep disruption, and digestive changes commonly accompany the mental strain. Small strategies like structured breathing, brief movement, and focusing on controllable tasks can bring relief in the moment.",tags:["anxiety"],severity:"moderate",symptoms:["Excessive worry","Restlessness","Irritability","Sleep trouble"],methods:[{title:"4-4-4 Breathing",type:"exercise",steps:["Breathe in for 4 seconds","Hold for 4 seconds","Exhale for 4 seconds","Repeat 4–6 times"]},{title:"Grounding 5-4-3-2-1",type:"exercise",steps:["Name 5 things you can see","4 things you can touch","3 things you can hear","2 things you can smell","1 thing you can taste"]}]},
  {id:2,name:"Panic Attacks",desc:"Episodes of intense fear or discomfort that come on quickly and can include strong physical sensations. A panic attack may feel overwhelming — with a racing heart, shortness of breath, dizziness, or a sense of losing control — even when there is no immediate danger. Learning grounding and breathing techniques can reduce intensity during an attack, and understanding triggers supports longer-term coping.",tags:["anxiety","panic"],severity:"high",symptoms:["Racing heart","Shortness of breath","Dizziness","Shaking"],methods:[{title:"Box Breathing",type:"exercise",steps:["Inhale 4s","Hold 4s","Exhale 4s","Hold 4s — repeat"]},{title:"Grounding (5 senses)",type:"exercise",steps:["Use your senses to re-orient yourself; list items out loud"]}]},
  ...
  {id:4,name:"Insomnia",desc:"Trouble falling asleep, staying asleep, or getting refreshing rest. Insomnia can be short-term (tied to stress) or chronic, and it affects mood, focus, and energy during the day. Improving sleep habits, creating a calming pre-bed routine, and practicing gentle breathwork can help reset sleep patterns over time.",tags:["sleep"],severity:"low",symptoms:["Trouble falling asleep","Waking at night","Daytime tiredness"],methods:[{title:"Bedtime Routine",type:"tip",steps:["Dim lights 30m before bed","Avoid screens","Try calming tea (non-caffeinated)"]},{title:"4-7-8 Breathing",type:"exercise",steps:["Inhale 4s","Hold 7s","Exhale 8s — repeat"]}]},
  {id:5,name:"Social Anxiety",desc:"Intense worry about social interactions, performance, or being judged by others. This can lead to avoidance of events, physical symptoms like blushing or sweating, and a strong desire to escape social situations. Gradual exposure, practicing small interactions, and grounding strategies can build confidence and reduce avoidance over time.",tags:["anxiety","social"],severity:"moderate",symptoms:["Fear of embarrassment","Avoiding events","Sweating or blushing"],methods:[{title:"Small Exposure",type:"tip",steps:["Try a short friendly interaction","Practice beforehand"]},{title:"Grounding",type:"exercise",steps:["Focus on breath and senses to stay present"]}]},
  {id:6,name:"PTSD (trauma response)",desc:"A set of reactions that can follow traumatic events, including intrusive memories, strong emotional responses, hypervigilance, and avoidance of reminders. People with PTSD may relive experiences through flashbacks or nightmares and feel constantly on guard. Stabilizing techniques such as grounding, safe-space visualisation, and paced breathing can help manage moments of distress, and trauma-focused care supports recovery.",tags:["trauma"],severity:"high",symptoms:["Flashbacks","Avoidance","Irritability","Sleep issues"],methods:[{title:"Safe-Space Visualization",type:"exercise",steps:["Close eyes, picture a calm safe place","Name details until you feel steadier"]},{title:"5-4-3-2-1 Grounding",type:"exercise",steps:["Use senses to reanchor"]}]},
  ...
  {id:8,name:"ADHD (inattention)",desc:"A profile of attention and executive function differences that make it harder to sustain focus, organize tasks, and manage time. People with ADHD often benefit from structured routines, external timers, and short movement breaks to reset attention. Small environmental adjustments and task chunking can make daily responsibilities more manageable.",tags:["adhd"],severity:"low",symptoms:["Easily distracted","Forgetful","Procrastination"],methods:[{title:"Pomodoro Mini",type:"tip",steps:["Work 25 minutes, break 5 minutes"]},{title:"Movement Breaks",type:"tip",steps:["Try 2 minutes of stretching or walking between tasks"]}]},
  {id:9,name:"PMS / Mood swings",desc:"Recurring mood changes, irritability, and physical symptoms that often follow a cyclical pattern related to hormonal shifts. These changes can affect energy, appetite, social interactions, and emotional balance. Self-care strategies, planning for sensitive days, and simple physical comforts can help reduce the impact of cyclical symptoms.",tags:["mood","hormones"],severity:"low",symptoms:["Irritability","Crying spells","Bloating"],methods:[{title:"Comfort Plan",type:"tip",steps:["Plan cozy activities","Use heat packs and gentle movement"]}]},
  {id:10,name:"Low Self-Esteem",desc:"A lasting tendency to view oneself negatively, undervalue achievements, or avoid new challenges due to fear of failure. Low self-esteem can affect relationships, work, and motivation, but it can shift with small, consistent practices like celebrating small wins, tracking strengths, and challenging unhelpful self-talk. Gentle, repeated experiences of success help rebuild confidence.",tags:["self"],severity:"low",symptoms:["Self-criticism","Avoiding challenges"],methods:[{title:"Affirmation Practice",type:"tip",steps:["Write three small achievements each day"]},{title:"Small Wins",type:"tip",steps:["Break tasks into tiny steps and celebrate each"]}]},
  {id:11,name:"Anger / Irritability",desc:"Powerful feelings of anger or irritability that may come on quickly or build over time. Anger is a natural emotion, but when it becomes frequent or overwhelming it can damage relationships and wellbeing. Strategies like taking a timeout, progressive muscle relaxation, and identifying triggers can reduce intensity and create space for calmer responses.",tags:["anger"],severity:"moderate",symptoms:["Tense muscles","Irritability","Yelling"],methods:[{title:"Timeout",type:"tip",steps:["Step away for 5 minutes","Try breathing or a short walk"]},{title:"Progressive Relaxation",type:"exercise",steps:["Tense and release muscle groups from feet to head"]}]},
  {id:12,name:"Obsessive Worry (health)",desc:"Persistent concerns about health that may continue despite reassurance, leading to frequent checking, rumination, and medical visits. Health-related worry can feel very convincing and exhausting, and it's often helpful to set structured checking times, practice redirecting attention, and use short grounding tasks to interrupt cycles of worry. Professional support can help when worries significantly impact daily life.",tags:["anxiety","health"],severity:"moderate",symptoms:["Checking symptoms","Frequent doctor visits"],methods:[{title:"Scheduled Checking",type:"tip",steps:["Limit checking to 2 planned times a day"]},{title:"Distraction Technique",type:"tip",steps:["Switch to a task for 15 minutes when worry rises"]}]} 
];
