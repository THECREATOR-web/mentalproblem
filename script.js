...
const PROBLEMS = [
  ...
  {id:3,name:"Depression (low mood)",desc:"Persistent sadness or loss of interest.",tags:["depression"],severity:"moderate",symptoms:["Low energy","Hopeless feelings","Sleep/appetite changes","Loss of interest"],methods:[{title:"Gentle Activity",type:"tip",steps:["Try a 5–10 minute walk","Do a tiny task you enjoy"]},{title:"Mood Journal",type:"tip",steps:["Write one thing you noticed that felt okay today"]}]},
  ...
  {id:7,name:"OCD (intrusive thoughts)",desc:"Unwanted thoughts and repetitive behaviors.",tags:["ocd"],severity:"moderate",symptoms:["Repetitive checking","Intrusive images or thoughts"],methods:[{title:"Delay Technique",type:"tip",steps:["If a compulsion arises, postpone for 10 minutes and note the urge"]},{title:"Mindful Observation",type:"exercise",steps:["Notice the thought without acting on it"]}]},
